...
% DAE
\lang{%
  Parallelization of an algorithm of planification Divide-and-Evolve, linear speedup in function of the number of cores, complexity of algorithmic, thread-safe variables and reentrant functions.%
}{%
  Parallélisation d'un algorithme de planification Divide-and-Evolve, accélération linéaire en fonction d'une nombre de coeurs, complexité algorithmique, variables thread-safe et fonctions réentrant.%
}
%
% EDA-SA
\lang{%
  Algorithms hybridation of estimation of distribution and simulated annealing.%
}{%
  Hybridation des algorithmes à estimation de distribution et de recuit simulé.%
}
%
% BOPO
\lang{%
...
\item[2009-2011]
  ...
  \textit{%
    \lang{%
      Parallelization of a planification algorithm. Hybridation of EDA-SA. Implementation of an automatic setting parameters interface.
    }{%
    }%
  }
...
\item[2009]
  ...
  \textit{%
    \lang{%
      In collaboration with the teams of Future-brand, London and Link.Net, Cairo in order to implement a new streaming technology connected to the large media database of the group: planning a road-map, developing and bug tracking some software features, writting documentations, following up meetings. Maintaining the datacenter and developing a rights media manager for the digital arching department.%
    }{%
...
\section{\lang{Realizations}{Réalisations}}
\begin{CV}[2]{-4.5ex}
\smallskip

\item[2011]
  \textbf{\lang{Implementation}{Implémentation}}
  \lang{%
    of an interface of parallelization in the framework EO ``Evolving Objects'' in C++ and using OpenMP available on \url{http://eo.sf.net}
  }{%
    d'une interface de parallélisation dans le framework EO ``Evolving Objects'' en C++ et utilisant OpenMP disponible sur le web: \url{http://eo.sf.net}
  }%

\item[2011]
  \textbf{\lang{Conception}{Conception}}
  \lang{%
    and implementation of a linear algebra computation framework in C++ along with a layout abstraction for parallelization paradigms. It provides operators to compute dense and sparse matrices with generically designed scalar, complex, vector and matrix types. The framework supports the library CUDA, CUBLAS, CUSP, CUSPARSE for parallel computing on GPGPU. Available on \url{https://github.com/canercandan/linear-algebra}
  }{%
    et implémentation d'un framework de calcul d'algèbre linéaire en C++ avec un niveau d'abstraction pour les paradigmes de parallélisation. Le framework fournit des opérateurs de calcul sur matrices denses et creuses avec des types scalaires, complexes, vecteurs et matrices génériques. Il supporte les librairies CUDA, CUBLAS, CUSP, CUSPARSE pour le calcul paralléle sur GPGPU. Disponible sur le web: \url{https://github.com/canercandan/linear-algebra}
  }%

\item[2010]
  \textbf{\lang{Conception}{Conception}}
  \lang{%
    and implementation of the framework EDO manipulating a distribution of probability available on \url{http://eodev.sf.net}
  }{%
    et implémentation du framework EDO manipulant une distribution de probabilité disponible sur le web: \url{http://eodev.sf.net}
  }%

\item[2009]
  \textbf{\lang{Implementation}{Implémentation}}
  \lang{%
    of an automatic setting parameters interface.
  }{%
    d'une interface de paramétrage automatique.
  }%
...
\item
  ...
  *BSD, GNU/Linux, Solaris, Assembler X86, C99, C++, Objective-C, J2EE, Lex, Yacc, Codeworker, PHP, Perl, ASP, JavaScript/Ajax, Ruby, Python, Xslt, CUDA, MPI, OpenMP, GNU Octave, Scilab, Gnuplot, Subversion, Git, Oracle, DB2, PostgreSQL, MySQL, SQLite.
